...
// Forward-declare HeatpumpIR class from library
class HeatpumpIR;
...
enum Protocol {
  ...
  PROTOCOL_MITSUBISHI_PLA,  // Added for PLA series with W001CP remote
...
// Simple enum to represent horizontal directions
