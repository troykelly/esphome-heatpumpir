...
PROTOCOLS = {
    ...
    "mitsubishi_pla": Protocol.PROTOCOL_MITSUBISHI_PLA,  # Added for PLA series with W001CP remote
...
async def to_code(config):
    ...
    # Use custom fork with mitsubishi_pla protocol
    cg.add_library("https://github.com/troykelly/arduino-heatpumpir.git", None)
